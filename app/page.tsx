    ...
    <div className={styles.pageContainer}>
      ...
      <main>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>Novidades na Casa da Palavra</h2>
          <p className={styles.sectionSubtitle}>Confira os títulos recém-chegados à nossa coleção.</p>
          {/* aqui dá p ter um carrossel */}
          <div className={styles.bookGrid}>
            {/* card de livro -- ver depois p criar um componente bookcard.tsx */}
            <div className={styles.bookCard}>
              <img src="https://placehold.co/150x220/8a2be2/ffffff?text=Livro+1" alt="Capa do Livro 1" className={styles.bookCover} />
            ...
            <div className={styles.bookCard}>
              <img src="https://placehold.co/150x220/ff69b4/ffffff?text=Livro+2" alt="Capa do Livro 2" className={styles.bookCover} />
              <h3 className={styles.bookTitle}>Aventura no Desconhecido</h3>
              <p className={styles.bookAuthor}>Por Escritor Misterioso</p>
              <button className={styles.viewButton}>Ver Detalhes</button>
            </div>
            <div className={styles.bookCard}>
              <img src="https://placehold.co/150x220/ffa500/ffffff?text=Livro+3" alt="Capa do Livro 3" className={styles.bookCover} />
        ...
        <section className={`${styles.section} ${styles.eventsSection}`}>
          ...
          <p className={styles.sectionSubtitle}>Participe de nossos workshops, clubes de leitura e encontros com autores.</p>
        ...
        <section className={`${styles.section} ${styles.aboutCtaSection}`}>
          <div className={styles.aboutContent}>
            <h2 className={styles.sectionTitle}>Sobre a Biblioteca Casa da Palavra</h2>
            <p>
              Somos um refúgio para amantes da leitura e buscadores de conhecimento. Nossa missão é promover a cultura,
              incentivar a leitura e ser um ponto de encontro para a comunidade.
            </p>
            <p>
              Com uma vasta coleção de livros, eventos culturais e um ambiente acolhedor, a Casa da Palavra é o seu
              lar para todas as histórias.
            </p>
          </div>
          <div className={styles.ctaContent}>
            <h2 className={styles.sectionTitle}>Torne-se um Membro!</h2>
            <p>Tenha acesso ilimitado à nossa coleção, participe de eventos exclusivos e muito mais.</p>
      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          <p>&copy; 2025 Biblioteca Casa da Palavra. Todos os direitos reservados.</p>
